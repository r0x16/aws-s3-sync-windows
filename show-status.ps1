<#
.SYNOPSIS
    Script para mostrar el estado actual de las sincronizaciones AWS S3

.DESCRIPTION
    Este script muestra un reporte detallado del estado de la última copia realizada,
...
function Show-StatusReport {
    try {
        ...
        Show-ColoredOutput "║                      REPORTE DE ESTADO AWS S3                   ║" "Cyan"
        Show-ColoredOutput "╚══════════════════════════════════════════════════════════════════╝" "Cyan"
        Show-ColoredOutput ""
        ...
        Show-ColoredOutput ""
        Show-ColoredOutput "╔══════════════════════════════════════════════════════════════════╗" "Cyan"
        Show-ColoredOutput "║                        FIN DEL REPORTE                          ║" "Cyan"
        Show-ColoredOutput "╚══════════════════════════════════════════════════════════════════╝" "Cyan"
        
    }
    catch {
        Show-ColoredOutput "❌ Error al generar reporte de estado: $_" "Red"
        exit 1
    }
}
